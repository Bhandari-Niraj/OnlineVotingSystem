...
<?php
  ...
  if (isset($_POST['btnActive'])) {
     ...
     if (isset($_POST['staff_type_id']) && !empty($_POST['staff_type_id'])) {
      ...
      $err['staff_type_id'] = "Select staff type to be Activated";
     }
     ...
     <script type="text/javascript">
      window.location = 'view_staff.php?msg=4';
     </script>
  <?php  }
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php  
                             if (isset($st)) {
                               if ($st = true) { ?>
                              <div class="alert alert-success"><?php echo $staff->staff_type;?> Staffs has been Activated   !!!</div> 
                              <?php }else{ ?>
                               <div class="alert alert-success"><?php echo $staff->staff_type;?> Staffs Cannot be Activated  !!!!!!</di>  
                               <?php }
                             }
                            ...
                            ?>
                                    ...
                                    <form role="form" action="" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-default" name="btnActive" >Activate Staff</button>
